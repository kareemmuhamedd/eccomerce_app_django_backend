...
SECRET_KEY = 'django-insecure-3gdnhm$8nd+u4@ez++k)h4czl$z&a2y0x%#1_hbt&ja7sl%av5'
...
# EMAIL_USE_SSL = False
# EMAIL_PORT = 587
# EMALI_HOST_USER = 'kareemmuhamed.eg@gmail.com'
# EMALI_HOST_PASSWORD = 'lkyckcgfbxnvnmbg'
